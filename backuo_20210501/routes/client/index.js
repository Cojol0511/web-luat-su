...
router.post('/lawyer/register', async function(req,res){
    ...
    await axios.post(api_url + 'lawyer/', lawyerObj,{
        ...
        .then(async function(response) {
            ...
            await axios.all([
                axiosInstance.post(api_url + 'lawyer/' + response.data.UserID + '/formation', lawyerFormation),
                axiosInstance.post(api_url + 'lawyer/' + response.data.UserID + '/experience', lawyerExperience),
                //axiosInstance.post(api_url + 'lawyer/' + response.data.UserID + '/domain', lawyerDomain),
            ]).then(function(responseArr) {
                console.log("Registration Successfully");
            }).catch(function(error) {
                console.log("Registration Unsucccessfully");
            })
...
router.put('/lawyer/dashboard/contact/:LawyerID', verifyToken, async function(req, res) {
    ...
    if (req.decode){
        ...
        if (req.params.LawyerID){
            ...
            await axiosInstance.put(api_url + 'address/' + req.params.LawyerID, req.body)
            .then(function(responseArr) {
                console.log(responseArr);
                res.json({
                    success: 1,
